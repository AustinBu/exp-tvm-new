...
def load_json_to_model(data):
    ...
    for i_node in initial_data:
        attr_list = []
        a = m.new_attrs(b'dims', 1, list(map(int, i_node['dims'])))[0]
        b = m.new_attrs(b'int32Data', 1, list(map(int, i_node['int32Data'])))[0]
